document.addEventListener('DOMContentLoaded', () => {
    ...
    .then(followList => {
        ...
        renderFollowingPosts(followIDList, page_id, currentUser_id, is_authenticated);
    });
});

function renderFollowingPosts(followIDList, page_id, currentUser_id, is_authenticated) {
    // Get posts
    fetch('/posts')
    .then(response => response.json())
    .then(posts => {
